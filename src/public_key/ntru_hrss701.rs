...
mod tests {
    ...
    fn nist_kat_count_zero() {
        ...
        let pk_hex = include_str!("ntru_hrss701_kat_count0_pk.hex");
        let sk_hex = include_str!("ntru_hrss701_kat_count0_sk.hex");
        let ct_hex = include_str!("ntru_hrss701_kat_count0_ct.hex");
        let ss_hex =
