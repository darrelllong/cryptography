...
/// little-endian.
///
/// A caller that needs the coordinates takes them from here rather than
/// encoding and decoding again: decoding recovers `x` with a square root,
/// which costs more than the multiplication that produced the point.
