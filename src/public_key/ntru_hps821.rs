...
fn kem_keypair_seeded<R: Csprng>(pk: &mut [u8], sk: &mut [u8], rng: &mut R) {
    crate::public_key::ntru_pqc_shared::kem_keypair_seeded::<Hps821Variant, R, N, LOGQ>(
        pk, sk, rng,
    );
}
...
fn kem_enc_seeded<R: Csprng>(
    ...
    crate::public_key::ntru_pqc_shared::kem_enc_seeded::<Hps821Variant, R, N, LOGQ>(c, k, pk, rng);
}
...
fn kem_dec(
    ...
    crate::public_key::ntru_pqc_shared::kem_dec::<Hps821Variant, N, LOGQ>(k, c, sk);
}
