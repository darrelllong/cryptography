...
fn apply_l(block: &mut [u8; 16]) {
    for _ in 0..16 { r_step(block); }
}

/// L⁻¹ = (R⁻¹)¹⁶.
fn apply_l_inv(block: &mut [u8; 16]) {
    for _ in 0..16 { r_inv_step(block); }
}
...
mod tests {
    ...
    fn round_const_vectors() {
        assert_eq!(round_const(1), h16("6ea276726c487ab85d27bd10dd849401"), "C_1");
        assert_eq!(round_const(2), h16("dc87ece4d890f4b3ba4eb92079cbeb02"), "C_2");
        assert_eq!(round_const(3), h16("b2259a96b4d88e0be7690430a44f7f03"), "C_3");
        assert_eq!(round_const(4), h16("7bcd1b0b73e32ba5b79cb140f2551504"), "C_4");
        assert_eq!(round_const(5), h16("156f6d791fab511deabb0c502fd18105"), "C_5");
        assert_eq!(round_const(6), h16("a74af7efab73df160dd208608b9efe06"), "C_6");
        assert_eq!(round_const(7), h16("c9e8819dc73ba5ae50f5b570561a6a07"), "C_7");
        assert_eq!(round_const(8), h16("f6593616e6055689adfba18027aa2a08"), "C_8");
    }
}
