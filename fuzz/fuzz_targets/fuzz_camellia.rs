//! Fuzz Camellia-128/192/256: roundtrip and regular-vs-Ct consistency.
#![no_main]
...
fuzz_target!(|data: &[u8]| {
    ...
    match data[0] % 3 {
        0 => roundtrip_pair!(&data[1..], 16, 16, Camellia128, Camellia128Ct),
        1 => roundtrip_pair!(&data[1..], 24, 16, Camellia192, Camellia192Ct),
        _ => roundtrip_pair!(&data[1..], 32, 16, Camellia256, Camellia256Ct),
    }
});
