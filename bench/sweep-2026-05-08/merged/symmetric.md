# Symmetric throughput — Wigner / Moore / Darby (2026-05-08)

Pilot-bench `--preset normal --confidence-level 0.90`. Workload 256 KiB per
round; each row reports the mean throughput with 90% CI half-width and the
number of pilot rounds required to reach the 10% CI-width target.

![Symmetric Kiviat (radar)](../../../assets/sweep-2026-05-08-symmetric-radar.svg)
