# Public-key latency — Wigner / Moore / Darby (2026-05-08)

Pilot-bench `--preset normal --confidence-level 0.90`. Each row reports the
mean ms/op with 90% CI half-width and rounds-to-CI. The two Kiviat charts
below are in **ops/sec** (the inverse of ms/op) so larger is better, on a
log-radial axis.

![RSA / DSA / EC ops/sec (radar)](../../../assets/sweep-2026-05-08-pk-rsa-ec-radar.svg)

![Post-quantum ops/sec — ML-KEM / ML-DSA / NTRU (radar)](../../../assets/sweep-2026-05-08-pk-pq-radar.svg)
